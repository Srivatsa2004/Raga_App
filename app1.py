...
if uploaded_file is not None:
    ...
    shruthis = {('C', 'Sa'): [261.63, 523.25], ('C#', 'R1'): [277.18, 554], ('D', 'R2/G1'): [293.66, 587.33],
                ('D#', 'R3/G2'): [311.13, 622.25], ('E', 'G3'): [329.63, 659.25], ('F', "M1"): [349.23, 698],
                ('F#', "M2"): [369.99, 739.99, 1479], ('G', "P"): [392, 783], ('G#', "D1"): [415.3, 83]}
